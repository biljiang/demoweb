...
def handler(signalnum, frame):
    global producer
    print ("Received SIGINT",signalnum,"close Producer and exit!")
    producer.close()
    exit(0) # 自己走
...
def main():
    global producer
    print ("pid:", os.getpid())
    T = pd.read_csv("/home/techstar/PyProjects/PowerPlant/test.csv",index_col=0,float_precision='round_trip')
